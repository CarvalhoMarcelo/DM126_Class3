...
let servicesMock : [ServiceType] = [
    ...
    ServiceType(id: 7, nome: "Coffee Time4", imagem: "App Icon"),
    ServiceType(id: 8, nome: "Coffee Time3", imagem: "App Icon"),
    ServiceType(id: 9, nome: "Coffee Time3", imagem: "App Icon"),
    ServiceType(id: 10, nome: "Coffee Time3", imagem: "App Icon")
]
